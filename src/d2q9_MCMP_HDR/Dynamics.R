...
AddField(name="rho_w", stencil2d=1)
...
AddSetting(name="DensCutOff_h", comment='for buoyancy on fluid' , zonal=T)
AddSetting(name="DensCutOff_g", comment='for buoyancy on fluid' , zonal=T)
# MultiComponent Settings:
AddSetting(name="G11", default=1.0, comment='fluid1/1 interaction')
AddSetting(name="G12", default=0.0, comment='fluid1/2 interaction')
AddSetting(name="G21", default=0.0, comment='fluid2/1 interaction')
AddSetting(name="G22", default=1.0, comment='fluid2/2 interaction')
AddSetting(name="Gw1", default=0.0, comment='fluid1-wall interation')
AddSetting(name="Gw2", default=0.0, comment='fluid2-wall interation')
# MultiPhase Settings:
AddSetting(name="T", default=1.0, comment='EoS reduced temp')
AddSetting(name="R1", default=1.0, comment='EoS gas const')
AddSetting(name="a1", default=1.0, comment='EoS a')
AddSetting(name="b1", default=4.0, comment='EoS b')
AddSetting(name="R2", default=1.0, comment='EoS gas const')
AddSetting(name="a2", default=1.0, comment='EoS a')
AddSetting(name="b2", default=4.0, comment='EoS b')
...
AddSetting(name="omega_PR1",default=0.344,comment='Acentric factor of liquid')
AddSetting(name="omega_PR2",default=0.344,comment='Acentric factor of gas')
# Turbulence Settings:
...
# Body Force Settings:
AddSetting(name="buoyancyX", default=0.0, comment='Body Force')
AddSetting(name="buoyancyY", default=0.0, comment='Body Force')
AddSetting(name="GravitationX", default=0.0, comment='Body Force')
AddSetting(name="GravitationY", default=0.0, comment='Body Force')
AddSetting(name="GravitationX_g", default=0.0, comment='Body Force on buoyant phase')
AddSetting(name="GravitationY_g", default=0.0, comment='Body Force on buoyant phase')
