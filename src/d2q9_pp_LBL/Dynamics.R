...
AddSetting(name="avgDensity",default=0,comment='use for buoyancy force')
...
AddSetting(name="nx", comment='size of x domain')
AddSetting(name="ny", comment='size of y domain')
...
AddGlobal(name="TotalDensity", comment='total density', unit="1kg/m3")
