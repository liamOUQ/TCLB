...
AddSetting(name="PhaseField_h", default=1, comment='Heavy Phase')
AddSetting(name="PhaseField_l", default=0, comment='light phase')
AddSetting(name="Density_h", comment='Heavy Phase')
AddSetting(name="Density_l", comment='light phase')
