...
AddDensity( name="feq[0]", group="feq")
AddDensity( name="feq[1]", group="feq")
AddDensity( name="feq[2]", group="feq")
AddDensity( name="feq[3]", group="feq")
AddDensity( name="feq[4]", group="feq")
AddDensity( name="feq[5]", group="feq")
AddDensity( name="feq[6]", group="feq")
AddDensity( name="feq[7]", group="feq")
AddDensity( name="feq[8]", group="feq")
AddField('PhaseF',stencil2d=2)
# Stages - processes to run for initialisation and each iteration
AddStage("BaseIteration", "Run",  save=Fields$group=="f" | Fields$group=="h", load=DensityAll$group=="f" | DensityAll$group =="h")
AddStage("calcPhaseF"   , save="PhaseF", load=DensityAll$group == "h" )
AddStage("BaseInit"     , "Init", save=Fields$group=="f" | Fields$group=="h", load=DensityAll$group=="f" | DensityAll$group =="h")

AddAction("Iteration", c("BaseIteration","calcPhaseF"))
AddAction("Init"     , c("BaseInit","calcPhaseF"))
# 	Outputs:
...
AddSetting(name="Density", comment="init density", zonal=T)
